               ...
               <div className='  w-[95%] flex items-center justify-between'>
                    <div className='flex items-center '>
                         ...
                         <div className='flex items-center justify-center gap-3'>
                              ...
                              <i class="fi fi-rs-angle-small-down mt-1  text-orange-500 text-2xl"></i>
                         </div>
                    ...
                    <div className='flex justify-between gap-10'>
                         <div className='cursor-pointer flex items-center justify-center gap-2 hover:text-orange-500 font-semibold'>
                              <i class="fi mt-1 fi-br-briefcase"></i>
                              <p>Swiggy Corporate</p>
                         </div>
                         <div className='cursor-pointer flex items-center justify-center gap-2 hover:text-orange-500 font-semibold'>
                              <i class="fi mt-1 fi-br-search"></i>
                              <p>Search</p>
                         </div>
                         <div className='cursor-pointer flex items-center justify-center gap-2 hover:text-orange-500 font-semibold'>
                              <i class="fi mt-1 fi-br-badge-percent"></i>
                              <p>Offers</p>
                         </div>
                         <div className='cursor-pointer flex items-center justify-center gap-2 hover:text-orange-500 font-semibold'>
                              <i class="fi mt-1 fi-br-info"></i>
                              <p>Help</p>
                         </div>
                         <div className='cursor-pointer flex items-center justify-center gap-2 hover:text-orange-500 font-semibold'>
                              <i class="fi mt-1 fi-rs-user"></i>
                              <p>Sign In</p>
                         </div>
                         <div className='cursor-pointer flex items-center justify-center gap-2 hover:text-orange-500 font-semibold'>
                              <i class="fi mt-1 fi-br-cart-shopping-fast"></i>
                              <p>Cart</p>
                         </div>
                    </div>
               </div>
